# --- !Ups
CREATE TABLE CHALLENGES(ID SERIAL PRIMARY KEY, NAME VARCHAR(1000) UNIQUE NOT NULL, CATEGORY VARCHAR(30) NOT NULL, CREATOR INTEGER NOT NULL, CREATION_DATE DATETIME NOT NULL, VIDEO_DESCRIPTION_URL VARCHAR(200));
