...
CREATE TABLE CHALLENGE_PARTICIPATIONS(ID SERIAL PRIMARY KEY, PARTICIPATOR INTEGER NOT NULL, CHALLENGE INTEGER NOT NULL, JOINED DATETIME NOT NULL, ENDING_DATE DATETIME, IS_CHALLENGE_RATED CHAR(1));
