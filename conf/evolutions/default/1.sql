...
CREATE TABLE COMMENTS(ID SERIAL PRIMARY KEY, AUTHOR_ID INTEGER NOT NULL, CREATION_TIMESTAMP TIMESTAMP NOT NULL, MESSAGE VARCHAR(250), RELEVANT_OBJECT_ID VARCHAR (100));
